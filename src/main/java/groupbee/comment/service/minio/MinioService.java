package groupbee.comment.service.minio;
...
@Service
public class MinioService implements groupbee.comment.service.minio.ObjectStorage {

    private final MinioClient client;

    public MinioService(groupbee.comment.config.MinioConfig config) {
